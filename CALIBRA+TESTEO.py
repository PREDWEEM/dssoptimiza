...
# App principal
# ----------------------------
file = st.file_uploader("📂 Subí un Excel con hojas ensayos, emergencia, tratamientos", type=["xlsx"])
...
if file:
    ...
    for _, row in ensayos.iterrows():
        ...
        resultados.append({
            ...
            "dataset": row["dataset"]  # <- ahora se lee directo del Excel
        })
